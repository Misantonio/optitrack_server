========================================================================
    APLICACIÓN DE CONSOLA: optitrack_server 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación optitrack_server.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación optitrack_server.


optitrack_server.vcxproj
...
optitrack_server.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado optitrack_server.pch y un archivo de tipos 
